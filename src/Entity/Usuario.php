...
class Usuario implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'id_usuario', targetEntity: Incidencia::class, orphanRemoval: true)]
    private $incidencias;
    ...
    public function removeIncidencia(Incidencia $incidencia): self
    {
        if ($this->incidencias->removeElement($incidencia)) {
            ...
            if ($incidencia->getIdUsuario() === $this) {
                $incidencia->setIdUsuario(null);
            }
        }
